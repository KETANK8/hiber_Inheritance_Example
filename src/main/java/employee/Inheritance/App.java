/**
 * @author Ketan Kumar
 * Illustrating EMPLOYEE MANAGEMENT SYSTEM TO CREATE EMPLOYEE , FRESHER EMPLOYEE, EXPERIENCD EMPLOYEE TO DATABASE USING INHRITANCE IN HIBERNATE 
 * AND PRINT DATA OF ONE OR ALL EMPLOYEE, DELETE EMPLOYEE USING DATA ACCESS OBJECT AND HQL 
 *
 */
